...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Передоплата 200 грн", Decimal(200)),
        ("передплата: 350", Decimal(350)),
        ("передопл. 400", Decimal(400)),
        ("предоплату 500", Decimal(500)),
        ("предплата — 600", Decimal(600)),
        ("аванс 700", Decimal(700)),
        ("Завдаток: 800 грн", Decimal(800)),
        ("задаток 900", Decimal(900)),
        ("часткова оплата 1 000", Decimal(1000)),
        ("частичная оплата 1 100", Decimal(1100)),
        ("predoplata 1200", Decimal(1200)),
        ("1 300 грн передоплата", Decimal(1300)),
        ("передоплата у розмірі 1 400 грн", Decimal(1400)),
        ("п/о 1500", Decimal(1500)),
        ("без передоплати", Decimal(0)),
        ("без предоплати 500", Decimal(0)),
        ("передоплата не потрібна 500", Decimal(0)),
    ],
)
