...
надсилає DirectAdmin щогодини о `:00`, крім тихого періоду з 01:00 до 09:00 за Києвом.
Для цього cron у DirectAdmin має бути `0 0,10-23 * * *`: звичайна синхронізація працює
о 00:00, потім з 10:00 до 23:00 включно. О 09:00 GitHub Actions виконує одну щоденну
поглиблену перевірку, тому загальний розклад залишається погодинним без подвійного запуску.
